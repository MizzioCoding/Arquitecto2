...
import portadaSantaFe from "../src/assets/Reformas/3_Santa _Fe/Renders/1.webp";
import portadaAlberti from "../src/assets/Viviendas/7_Alberti/1.webp";
import portadaSmata from "../src/assets/Viviendas/9_SMATA/Renders/8.webp";
...
import portadaPorteniaBar from "../src/assets/Viviendas/1_Faena_La_Porteña_Bar/Renders/1.webp";
import portadaTrenesArgentinos from "../src/assets/Comercial/6_Trenes_Argentinos/Renders/1.webp";
import portadaPorteniaBiblioteca from "../src/assets/Viviendas/3_Faena_La_Porteña_Biblioteca/Renders/1.webp";
import portadaPorteniaLiving from "../src/assets/Viviendas/2_Faena_La_Porteña_Living/Renders/1.webp";
import portadaManuelaPedraza from "../src/assets/Reformas/1_Manuela_Pedraza/Renders/1.webp";
...
import portadaReformaBeruti from "../src/assets/Reformas/Beruti/Renders/1.webp";
...
const Gallery = () => {
  ...
  const images = [
    ...
    { src: portadaSantaFe, srctxt: '../src/assets/Reformas/3_Santa _Fe/Renders/1.webp', text: "REFORMAS Santa Fe" },
    ...
    { src: portadaPorteniaBar, srctxt: '../src/assets/Viviendas/1_Faena_La_Porteña_Bar/Renders/1.webp', text: "VIVIENDAS La Porteña Bar" },
    ...
    { src: portadaPorteniaBiblioteca, srctxt: '../src/assets/Viviendas/3_Faena_La_Porteña_Biblioteca/Renders/1.webp', text: "VIVIENDAS La Porteña Biblioteca" },
    { src: portadaPorteniaLiving, srctxt: '../src/assets/Viviendas/2_Faena_La_Porteña_Living/Renders/1.webp', text: "VIVIENDAS La Porteña Living" },
    { src: portadaManuelaPedraza, srctxt: '../src/assets/Reformas/1_Manuela_Pedraza/Renders/1.webp', text: "REFORMAS Manuela Pedraza" },
    ...
    { src: portadaSmata, srctxt: '../src/assets/Viviendas/9_SMATA/Renders/8.webp', text: "VIVIENDAS SMATA" },
    { src: portadaCosta, srctxt: '../src/assets/Concursos/3_Concurso_Costa_Urbana/1.webp', text: "CONCURSO Costa Urbana" },
    {src:portadaReformaBeruti , srctxt: '../src/assets/Reformas/Beruti/Renders/1.webp', text: "REFORMAS Beruti"},
...
const LazyImage = ({ src, alt, text, onClick }) => {
  ...
  console.log("cambio miche miche michedasadasdsads");
